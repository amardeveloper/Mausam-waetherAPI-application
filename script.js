...
window.addEventListener("load", () => {
  ...
  if (navigator.geolocation) {
    navigator.geolocation.getCurrentPosition((position) => {
      ...
      const api = `${proxy}http://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${long}&appid=e8f88e7e1e58a973f6cce71a4cebb1b6`;
      fetch(api)
        .then((response) => {
        ...
        .then((data) => {
          ...
          alert("Hello! I am Amar,Please refresh and provide your location.");
        }
});
